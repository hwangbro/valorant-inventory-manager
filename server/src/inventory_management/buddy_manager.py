...
class Buddy_Manager:
    ...
    def refresh_buddy_inventory():
        ...
        buddy_entitlements = Entitlement_Manager.fetch_entitlements(valclient, "buddy")[
            "Entitlements"
        ]
        ...
        for entitlement in buddy_entitlements:
            ...
            sanitized_buddy_entitlements[entitlement["ItemID"]].append(
        ...
        for buddy in client.all_buddy_data:
            ...
            if buddy_owned:
                ...
                buddy_payload["instance_count"] = len(
                    sanitized_buddy_entitlements[owned_level_id]
                )
                ...
                for instance in sanitized_buddy_entitlements[owned_level_id]:
                    try:
                        buddy_payload["instances"][instance] = {
                            "uuid": instance,
                            "favorite": (
                                existing_buddy_data["instances"][instance]["favorite"]
                                if existing_buddy_data is not None
                                else False
                            ),
                            "super_favorite": (
                                existing_buddy_data["instances"][instance][
                                    "super_favorite"
                                ]
                                if existing_buddy_data is not None
                                else False
                            ...
                            "locked": (
                                existing_buddy_data["instances"][instance]["locked"]
                                if existing_buddy_data is not None
                                else False
                            ),
                            "locked_weapon_uuid": (
                ...
                for instance in buddy_payload["instances"].values():
                    if instance["locked"]:
                        ...
                        if (
                            ...
                            or instance["locked_weapon_display_name"] == ""
                        ):
