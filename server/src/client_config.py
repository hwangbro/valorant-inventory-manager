...
UNLOCK_ALL_BUDDIES = (
    False  # just for testing purposes, doesn't actually unlock anything
)
...
# client overrides
COLLECTIONS_WITH_BAD_LEVEL_IMAGES = [
    "975f7716-498d-8e0b-b7c7-02b507b8e14a",
    "9436fe00-4156-e115-b11f-f69cac91a6a5",
    "8a34391f-4d1f-6b22-859f-628bff79d381",
]  # collections with bad LEVEL images in valorant-api
